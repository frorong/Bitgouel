      ...
      >
        <S.Content id="sec1">
          ...
          <S.TextWrapper>
            ...
            <S.Description>
              빛고을국민체육센터 4층에 위치한 빛고을 배드민턴 클럽은 최고의
              시설을 자랑합니다.
            </S.Description>
            <S.Description>
              총 6개의 코트가 구비되어있습니다. 빛고을 배드민턴 클럽의 회원들은
              녹색 고무로 된 코트에서 낮은 부상 위험으로 게임을 즐길 수
              있습니다.
            </S.Description>
            <S.Description>
              추가요금 없이 이용할 수 있는 샤워실이 존재합니다. 땀흘리며 게임을
              한 이후 개운한 몸과 마음으로 귀가할 수 있습니다.
            </S.Description>
          </S.TextWrapper>
        </S.Content>
      </S.Container>
      ...
      >
        <S.Content id="sec2">
          ...
          <S.TextWrapper>
            ...
            <S.Description>
              빛고을 배드민턴 클럽은 역사적으로 깊은 전통과 뛰어난 다수의
              회원들이 존재합니다.
            </S.Description>
            <S.Description>
